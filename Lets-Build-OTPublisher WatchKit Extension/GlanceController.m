...
- (void)willActivate {
    ...
    _session = [[OTSession alloc] initWithApiKey:kApiKey
                                       sessionId:kSessionId
                                        delegate:self];
    [_session performSelector:@selector(setApiRootURL:) withObject:[NSURL URLWithString:@"https://anvil-tbdev.opentok.com"]];
    [self doConnect];

    // This method is called when watch view controller is about to be visible to user
    //[self.interfaceImage setImage:nil];
    [super willActivate];
}
...
- (void)subscriberDidConnectToStream:(OTSubscriberKit*)subscriber
{
    ...
    [_subscriber.view setFrame:CGRectMake(0, widgetHeight, widgetWidth,
                                          widgetHeight)];
    _subscriber.interfaceImage = self.interfaceImage;
    _subscriber.interfaceGroup = self.interfaceGroup;
